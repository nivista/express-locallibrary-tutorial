...
exports.book_delete_get = function (req, res, next) {
    //if the book doesn't exist go to book list
    //get all bookinstances
    //if there are some book instances show you should delete this first screen
    //otherwise show are you sure you want to delete this screen
